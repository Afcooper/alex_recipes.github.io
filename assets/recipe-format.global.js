...
const KNOWN_COURSES = ['Breakfast', 'Lunch', 'Dinner', 'Appetizer', 'Side', 'Salad',
...
function parseIngredient(lineRaw) {
...
function stepContentToFriendly(content, ingredients) {
